...
LC_ALL=en_US.UTF-8 "$SED_PROG" -f p1 </dev/null >out1 || fail=1
...
LC_ALL=en_US.UTF-8 "$SED_PROG" -f p2 </dev/null >out2 || fail=1
...
LC_ALL=en_US.UTF-8 "$SED_PROG" -f p3 </dev/null >out3 || fail=1
