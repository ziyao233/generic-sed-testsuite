...
LC_ALL="$LOCALE_JA_SJIS" "$SED_PROG" -f p1 <in1 >out1 || fail=1
...
LC_ALL="$LOCALE_JA_SJIS" "$SED_PROG" -f p2 </dev/null 2>out2 || fail=1
...
LC_ALL="$LOCALE_JA_SJIS" "$SED_PROG" -f p3 </dev/null >out3 || fail=1
...
LC_ALL="$LOCALE_JA_SJIS" "$SED_PROG" -f p4 </dev/null >out4 || fail=1
